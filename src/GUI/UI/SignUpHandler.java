...
/**
 * @author Larissa Goh 18029695 This class handles all logic for signing up.
 * including validating user inputs it validates user inputs for to create an
 * account. such as full name, email, and password before registration.
 */
